...
- 💉 **Dependency Injection** The code is built using [typedi](https://github.com/typestack/typedi) and [router-controllers](https://github.com/typestack/routing-controllers) allowing you to write beautiful and clean APIs with less code.
- 📗 **API Documentation**: Out of the box the app automagically generates the Swagger UI thanks to [swagger-ui-express](https://www.npmjs.com/package/swagger-ui-express) and [router-controllers-openapi](https://github.com/epiphone/routing-controllers-openapi)
